                ...
                <div class="login-info-word">
                    ...
                    <div class="tab-info-wrapper">
                        <div class="tab-info" v-if="tabshow === 1">
                            ...
                            <p class="name">
                                <el-input placeholder="用户名/手机" v-model.trim="login.user" @blur='verificationUser' :maxlength='20'>
                                    <i slot="prefix" class="el-input__icon el-icon-user"></i>
                                </el-input>
                            </p>
                            <p class="password">
                                <el-input placeholder="密码" v-model.trim="login.password" @blur='verificationPassword' :type="pwdType" :maxlength='16'>
                            ...
                            <div class="Verification">
                                ...
                                <div @click="refreshCode">
                                    <s-identify class="code" :identifyCode="identifyCode" :contentWidth='86' :contentHeight='28'></s-identify>
                                </div>

                            </div>

                            <el-button type="primary" class="submit" @click="AccountLogin">登录</el-button>
                            <router-link :to="{ path: '/findPwd'}" class='findPwd'>找回密码</router-link>
...
export default {
	...
	methods: {
		...
		AccountLogin() {
			if (
				parseInt(this.login.verificationCodes) !== parseInt(this.identifyCode)
			) {
				this.errInfo = '验证码错误';
				this.showErrInfo = true;
				setTimeout(() => {
